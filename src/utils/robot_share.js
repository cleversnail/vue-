export default function robot_share(title1, title2, desc , link, imgUrl) {
  ...
  link = link || `${location.origin}/active_web/#/robot`;
  imgUrl = imgUrl || `http://img.kankanyisheng.com/yikan-t/20170929/15066725689916828733.png`;
  // imgUrl = imgUrl || `http://img.kankanyisheng.com/4551502345273tMkrOnpKBT.jpg`;
