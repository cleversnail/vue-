  ...
  <div class="answer">
    <div class="user">
      <div class="user__media">
        <img class="user__headimg" :src="item.member.headimg" alt="">
      </div>
      <div class="user__main">
        <div class="user__name">
          {{item.member.nickname}} <span class="user__time">{{item.addtime}}</span>
        </div>
    ...
    <div class="answer__footer" v-show="isShow">
      ...
      <textarea class="answer__textarea" v-model="form.content"></textarea>
